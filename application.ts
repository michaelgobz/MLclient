...
class PixelGrid {
    ...
    postRequest(request: any) {
        ...
        const url = 'https://ussouthcentral.services.azureml.net/workspaces/b02f57e6c1ae4146b31c7555455e466b/services/a5477f0dd0884f7cbf84cab974650222/execute?api-version=2.0&details=true';
        const apiKey = 'pv+5e8YQQ0Qk0ArRZbUiHfLZNDbwIdbyixTWxBxAz2dQan3s+LybHvVu/cSl95FF069/UzSco678NQUqZm3+2A==';
